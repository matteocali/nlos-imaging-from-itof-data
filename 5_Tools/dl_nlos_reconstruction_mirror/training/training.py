...
train_filename = str(Path(f"Z:/decaligm/thesis-nlos-for-itof/5_Tools/dl_nlos_reconstruction_mirror/training\data/data/train_n40200_s{str(P)}_nonorm{str_freqs}.h5"))
val_filename = str(Path(f"Z:/decaligm/thesis-nlos-for-itof/5_Tools/dl_nlos_reconstruction_mirror/training\data/data/val_n13400_s{str(P)}_nonorm{str_freqs}.h5"))
