...
if fl_get_train:
    ...
    Back, Back_nod, gt_real, Fit_Parameters, peak_ind, peak_val, v_real, v_real_no_d, v_real_d, phi, Back_fit = acquire_pixels(train_files, n_patches, max_imgs, f_ran, s, flag_ow, flag_fit, fl_normalize_transient, freqs)
    ...
    with h5py.File(file_train, 'w') as f:
        ...
        dset = f.create_dataset("gt", data=gt_real, compression="gzip")
...
if fl_get_val:
    ...
    print("\nValidation dataset:")
    Back, Back_nod, gt_real, Fit_Parameters, peak_ind, peak_val, v_real, v_real_no_d, v_real_d, phi, Back_fit = acquire_pixels(val_files, n_patches, max_imgs, f_ran, s, flag_ow, flag_fit, fl_normalize_transient, freqs)
    num_elem = Back.shape[0]
...
if fl_get_test:
    ...
    print("\nTest dataset:")
    Back, Back_nod, gt_real, Fit_Parameters, peak_ind, peak_val, v_real, v_real_no_d, v_real_d, phi, Back_fit = acquire_pixels(test_files, n_patches, max_imgs, f_ran, s, flag_ow, flag_fit, fl_normalize_transient, freqs)
    num_elem = Back.shape[0]
