...
#data_dir = "../../../../mitsuba_renders/nlos_scenes/datasets/depth_map_ground_truth_far/final_dataset/"  # data directory unix
data_dir = "Z:/decaligm/mitsuba_renders/nlos_scenes/datasets/depth_map_ground_truth_far/final_dataset/"  # dataset directory win
